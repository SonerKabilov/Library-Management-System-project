	...
	<div class="page-content">
		...
		<div class="book-results">
			...
			if(isset($_POST['submit'])) {
				...
				$sql = "SELECT * FROM books b INNER JOIN audiobooks a ON a.book_id = b.book_id WHERE book_title LIKE '%$search%' OR book_author LIKE '%$search%' OR book_isbn = '$search';";
			} else {
				$sql = "SELECT * FROM books b INNER JOIN audiobooks a ON a.book_id = b.book_id";
			}

			bookResults($conn, $sql, "audiobook");
			?>
		</div>
	</div>
